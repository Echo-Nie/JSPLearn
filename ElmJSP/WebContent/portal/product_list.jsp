...
<head>
    ...
    <style type="text/css">
        body {
            background-image: url('/eshop/images/background2.jpg'); /*  */
...
<div id="listDiv">
    ...
    <table class="table table-bordered table-sm table-hover"
           style="width: 900px; text-align: center;  border: 1px solid #000;">
        <thead>
        <tr>
            <th>商品名</th>
            <th>展示图</th>
            ...
            <form action="add_to_cart" method="post">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="submit" class="btn btn-danger btn-sm" ${prod.stock==0?"disabled":""}
                               value="加入购物车">
                    </td>
                </tr>
            </form>
